    ...
    <div>
      ...
      <div className="lg:flex sm:inline p-5">
        ...
        <div className="lg:w-1/2 sm:w-full p-4">
          ...
          <p className="p-5">
            A lot of undergraduate Computer Science students often shy away from internship opportunities. Whether the reason is that it's too stressful to handle both school and an internship or they already have a job in an unrelated field, employers want experienced talent and they don't want excuses. RCS Technology assists students to reach an all-new level of success by getting them trained on software development.
          </p>
        </div>
      </div>
      {/* Content and picture row ends */}
