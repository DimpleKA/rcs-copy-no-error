    ...
    <>
      ...
      <div className="lg:flex sm:inline p-5">
        <div className="lg:w-1/2 sm:w-full p-4">
          <p className=" font-semibold text-3xl text-red-600">RCS Technology</p>
          <p className="p-5">
      ...
      <div className="lg:flex sm:inline p-5">
        <div className="lg:w-1/2 sm:w-full p-4">
          <p className=" font-semibold text-3xl text-red-600">Our Mission</p>
          <p className="p-5">
            RCS TECHNOLOGY-“A trusted Business Partner”. “We believe Our Success
            is in Our Client’s Success“. “So we are here to make your dream come
            true”.
          </p>
        </div>
        <div className="lg:w-1/2 sm:w-full p-4">
          <p className=" font-semibold text-3xl text-red-600">Our Vision</p>
          <p className="p-5">
            Here’s a team who have a great passion towards their work, we work
            with care and make sure our client’s business objectives are met.
          </p>
        </div>
      </div>
      {/* Content and picture row ends */}

      <div className="lg:flex p-5 text-4xl text-red-600 font-bold justify-center">
        Management
      </div>
      {/* content and picture row starts  */}
      <div className="lg:flex sm:inline p-5">
        ...
        <div className="lg:w-2/3 sm:w-full p-4">
          <p className=" font-semibold text-3xl text-red-600"></p>
          <p className="p-5 border-2 border-gray-300">
            ...
            exploring what was formerly off the beaten path, RCS has marked the
            ray of Sunshine by accomplishing these all. Dedication, commitment,
            quality, and performance-driven approach are some of our resilience
            fundamental characteristics. RCS does this through the combination
            of product design and development, system improvement, and cost
            controls in manufacturing and marketing operations Our diverse
            talented team is our greatest asset. We have got our own beliefs,
            values, and codes of practice, that are highly nurtured inside the
            company and append a keen focus on technology, clients, and above
            all, the society. The ongoing optimization of our organization’s
            operational and manufacturing process creates maximum cost
            efficiency by using resources optimally. RCS has always been a
            flag-bearer in an effort to bring the technology ahead of time. So,
            we strived to be the best IT industry that delivers sustainable
            business, software excellence, and great revenue generation On a
            final note, we firmly believe that the future holds promise for us.
            We are proud of having earned the patronage of many reputed
            companies and strive to add many more to our customer base. We
            pledge to see our growth in yours and have customer focus as our
            guiding light. So if you are an enterprise or a professional, as a
            consumer or a supplier, I welcome you as a co-traveler in our quest
      ...
      {/* our skill start  */}
      <div className="w-full text-red-500 font-bold text-3xl p-5 text-center">
        Our Skills
      </div>
      <div className="p-4 flex w-full">
      <div className="border rounded-full bg-red-500 font-bold   text-white text-3xl">
  PHP Wordpress React JS
</div>

        <div className="">App Development ANDROID / IOS</div>
        <div className="">WEBSITES Design & Develop</div>
        <div className="">Digital Marketing Graphics Designing</div>
      </div>
